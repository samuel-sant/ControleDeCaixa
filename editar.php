...
if($doc != ""){
    $query = "UPDATE info SET endereco='$end', entrada='$ent', saida='$sai' WHERE id_doc='$doc'";
    mysqli_query($conexao, $query);
    echo "<h3 align='left' style = 'color: green ;' class='container';>Os dados foram editados com sucesso!!</h3> ";
}
else
{
    echo "<h3 align='left' style = 'color: red ;' class='container';>Os dados não foram editados, conferir o ID</h3> ";
}
